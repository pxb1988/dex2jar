...
public class DumpDexCodeAdapter extends DexCodeAdapter implements DexOpcodes {
     ...
     * (non-Javadoc)
     * 
     * @see com.googlecode.dex2jar.visitors.DexCodeAdapter#visitArrayInsn(int, java.lang.String, int, int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.googlecode.dex2jar.visitors.DexCodeAdapter#visitInsn(int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.googlecode.dex2jar.visitors.DexCodeAdapter#visitLineNumber(int, int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.googlecode.dex2jar.visitors.DexCodeAdapter#visitLocalVariable(java.lang .String, java.lang.String,
