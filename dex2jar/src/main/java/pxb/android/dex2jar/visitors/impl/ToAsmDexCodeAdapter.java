 ...
 *
 */
public class ToAsmDexCodeAdapter implements DexCodeVisitor {
	...
	/* (non-Javadoc)
	 * @see pxb.android.dex2jar.visitors.DexCodeVisitor#visitRegister(int)
	 */
	public void visitRegister(int registers_size) {
		// TODO Auto-generated method stub
